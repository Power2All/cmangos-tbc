...
## Authors of the Rust code

All of the code in Rust, is mostly if not almost fully, a 1:1 conversion of the source code in CMaNGOS, and are authored by the respective authors shown above.
The following authors are basically the ones doing conversion, or with help from AI to experiment with:

* Power2All
* Claude.AI (for most of the conversion work)
